...
interface Props {
  ...
  loaderVersions: (string | FabricVersionItem)[]
    ...
    <div className="h-full flex flex-col">
      <div className="pb-4 border-b border-white/10">
        <div className="flex items-center gap-4 mb-4">
          <h3 className="text-2xl font-bold text-purple-400 whitespace-nowrap">Chọn Fabric Loader</h3>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg font-medium transition-all ${
              showStep === 'loader' ? 'bg-purple-500 text-white' : 'bg-white/10'
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div>
                        <p className="font-medium">Fabric {version}</p>
